...
```
curl "https://nubesgen.com/azuredemo.zip?iactool=TERRAFORM&region=northeurope&application=SPRING_CLOUD.basic&runtime=DOCKER&database=NONE.free&gitops=true" | tar -xzvf -
```
